            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-lg px-4 py-2 font-medium text-slate-600 duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-meta-4 dark:text-slate-300 ${
                          (pathname === "/" ||
                            pathname.includes("dashboard")) &&
                          "text-green-600 bg-green-50 hover:bg-green-100 dark:hover:bg-emerald-900 dark:hover:bg-opacity-30 dark:text-emerald-400 dark:bg-opacity-30 dark:bg-emerald-950"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-lg px-4 py-2 font-medium text-slate-600 duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-meta-4 dark:text-slate-300 ${
                    pathname.includes("profile") && "text-green-600 bg-green-50 hover:bg-green-100 dark:hover:bg-emerald-900 dark:hover:bg-opacity-30 dark:text-emerald-400 dark:bg-opacity-30 dark:bg-emerald-950"
                  }`}
                >
                  <svg
                    className="fill-current"
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              ...
                              className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-slate-300 ${
              ...
              <li>
                <Link
                  href="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-lg px-4 py-2 font-medium text-slate-600 duration-300 ease-in-out hover:bg-slate-100 dark:hover:bg-meta-4 dark:text-slate-200  ${
                    pathname.includes("tables") && "text-green-600 bg-green-50 hover:bg-green-100 dark:hover:bg-emerald-900 dark:hover:bg-opacity-30 dark:text-emerald-400 dark:bg-opacity-30 dark:bg-emerald-950 "
                  }`}
                >
                  <svg
                    className="fill-current"
